...
\normalsize $^a$National Laboratory of Pattern Recognition, Institute of Automation, Chinese Academy of Sciences, Beijing, China\\
	...
	\normalsize $^c$University of Chinese Academy of Sciences, Beijing, China}
\address{}
...
\begin{figure}[t]
    ...
    \vspace{-1cm}
    \caption{A comparison of our method with the stage-of-the-art trackers SiamMask and SiamFCv2 in challenging situations. The example frames are from the GOT-10k testing set. Our approach effectively handles poor object appearance compared to existing approaches.}
    \vspace{-0.5cm}
